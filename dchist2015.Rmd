...
title("abc", sub = "Weighted by Shared Members",cex.main = 2,   font.main= 2, col.main= "blue", cex.sub = 2, font.sub = 3, col.sub = "red")  

#legend("bottomleft", legend = c("AAAS-American Academy of Arts and Sciences", "Circuit/Appeal", "SCOTUS", "Other"),
       title = "Court type")
