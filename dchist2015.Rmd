...
militgeo = read.csv("~/Desktop/DCHS2015/data/militacadlist.csv")
#Preparing 1830 Map
...
ggplot () + geom_map(data=fort2, map=fort2, aes(x=long, y=lat, group=group, map_id=id), color="black", fill="white") +geom_point(data=milit_soc_geocoded, aes (x=lon, y=lat), color="red") + coord_map()
